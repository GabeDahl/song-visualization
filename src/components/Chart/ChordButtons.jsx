...
import { makeStyles, Typography, Grid, Select, MenuItem, InputLabel, FormControl } from '@material-ui/core';
            ...
            {Object.keys(chords).map((group) => (
                <Grid item xs={6} sm={3}>
                    <FormControl style={{width: '100%'}}>
                        <InputLabel id={group}><Typography color='primary'>{group}</Typography></InputLabel>
                        <Select onChange={props.handleChordClick} labelId={group} color='primary' className={classes.select} inputProps={{classes: {icon: classes.icon}}}> 
